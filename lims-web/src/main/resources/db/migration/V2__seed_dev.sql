-- Flyway V2 seed data (issue #18)
-- Migrated from init.sql so production deployments via Flyway get seed rows,
-- not only first-time docker-entrypoint-initdb.d runs.
